...
import org.ypbay.common.application.ypbaypplicationContext;
...
public class NodeManagerTest {
  ...
  private ypbayApplicationContext context;
  ...
  public void init() {
    ...
    Args.setParam(new String[]{"--output-directory", "output-directory", "--debug"},
        Constant.TEST_CONF);
    context = new ypbayApplicationContext(DefaultConfig.class);
