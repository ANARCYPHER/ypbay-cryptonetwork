package org.ypbay.core.zen.note;

import static org.ypbay.common.zksnark.JLibsodium.CRYPTO_AEAD_CHACHA20POLY1305_IETF_NPUBBYTES;
import static org.ypbay.core.utils.ZenChainParams.ZC_ENCCIPHERTEXT_SIZE;
import static org.ypbay.core.utils.ZenChainParams.ZC_ENCPLAINTEXT_SIZE;
import static org.ypbay.core.utils.ZenChainParams.ZC_OUTCIPHERTEXT_SIZE;
import static org.ypbay.core.utils.ZenChainParams.ZC_OUTPLAINTEXT_SIZE;
import static org.ypbay.core.zen.note.NoteEncryption.Encryption.NOTEENCRYPTION_CIPHER_KEYSIZE;
...
import org.ypbay.common.zksnark.JLibsodium;
import org.ypbay.common.zksnark.JLibsodiumParam.Black2bSaltPersonalParams;
import org.ypbay.common.zksnark.JLibsodiumParam.Chacha20Poly1305IetfEncryptParams;
import org.ypbay.common.zksnark.JLibsodiumParam.Chacha20poly1305IetfDecryptParams;
import org.ypbay.common.zksnark.LibrustzcashParam.KaAgreeParams;
import org.ypbay.common.zksnark.LibrustzcashParam.KaDerivepublicParams;
import org.ypbay.core.exception.ZksnarkException;
import org.ypbay.core.utils.ZenChainParams;
import org.ypbay.core.zen.address.DiversifierT;
import org.ypbay.core.zen.note.NoteEncryption.Encryption.EncCiphertext;
import org.ypbay.core.zen.note.NoteEncryption.Encryption.EncPlaintext;
import org.ypbay.core.zen.note.NoteEncryption.Encryption.OutCiphertext;
import org.ypbay.core.zen.note.NoteEncryption.Encryption.OutPlaintext;
