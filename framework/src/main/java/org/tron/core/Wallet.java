...
package org.ypbay.core;

import static org.ypbay.common.utils.Commons.getAssetIssueStoreFinal;
import static org.ypbay.common.utils.Commons.getExchangeStoreFinal;
import static org.ypbay.common.utils.WalletUtil.isConstant;
import static org.ypbay.core.config.Parameter.ChainConstant.BLOCK_PRODUCED_INTERVAL;
import static org.ypbay.core.config.Parameter.DatabaseConstants.EXCHANGE_COUNT_LIMIT_MAX;
import static org.ypbay.core.config.Parameter.DatabaseConstants.MARKET_COUNT_LIMIT_MAX;
import static org.ypbay.core.config.Parameter.DatabaseConstants.PROPOSAL_COUNT_LIMIT_MAX;
...
import org.ypbay.api.GrpcAPI.AccountNetMessage;
import org.ypbay.api.GrpcAPI.AccountResourceMessage;
import org.ypbay.api.GrpcAPI.Address;
import org.ypbay.api.GrpcAPI.AssetIssueList;
import org.ypbay.api.GrpcAPI.BlockList;
import org.ypbay.api.GrpcAPI.BytesMessage;
import org.ypbay.api.GrpcAPI.DecryptNotes;
import org.ypbay.api.GrpcAPI.DecryptNotes.NoteTx;
import org.ypbay.api.GrpcAPI.DecryptNotesTRC20;
import org.ypbay.api.GrpcAPI.DelegatedResourceList;
import org.ypbay.api.GrpcAPI.DiversifierMessage;
import org.ypbay.api.GrpcAPI.ExchangeList;
import org.ypbay.api.GrpcAPI.ExpandedSpendingKeyMessage;
import org.ypbay.api.GrpcAPI.IncomingViewingKeyMessage;
import org.ypbay.api.GrpcAPI.NfParameters;
import org.ypbay.api.GrpcAPI.NfTRC20Parameters;
import org.ypbay.api.GrpcAPI.Node;
import org.ypbay.api.GrpcAPI.NodeList;
import org.ypbay.api.GrpcAPI.NoteParameters;
import org.ypbay.api.GrpcAPI.NumberMessage;
import org.ypbay.api.GrpcAPI.PaymentAddressMessage;
import org.ypbay.api.GrpcAPI.PrivateParameters;
import org.ypbay.api.GrpcAPI.PrivateParametersWithoutAsk;
import org.ypbay.api.GrpcAPI.PrivateShieldedTRC20Parameters;
import org.ypbay.api.GrpcAPI.PrivateShieldedTRC20ParametersWithoutAsk;
import org.ypbay.api.GrpcAPI.ProposalList;
import org.ypbay.api.GrpcAPI.ReceiveNote;
import org.ypbay.api.GrpcAPI.Return;
import org.ypbay.api.GrpcAPI.Return.response_code;
import org.ypbay.api.GrpcAPI.ShieldedAddressInfo;
import org.ypbay.api.GrpcAPI.ShieldedTRC20Parameters;
import org.ypbay.api.GrpcAPI.ShieldedTRC20TriggerContractParameters;
import org.ypbay.api.GrpcAPI.SpendAuthSigParameters;
import org.ypbay.api.GrpcAPI.SpendNote;
import org.ypbay.api.GrpcAPI.SpendResult;
import org.ypbay.api.GrpcAPI.TransactionApprovedList;
import org.ypbay.api.GrpcAPI.TransactionExtention;
import org.ypbay.api.GrpcAPI.TransactionExtention.Builder;
import org.ypbay.api.GrpcAPI.TransactionInfoList;
import org.ypbay.api.GrpcAPI.WitnessList;
import org.ypbay.common.crypto.Hash;
import org.ypbay.common.crypto.SignInterface;
import org.ypbay.common.crypto.SignUtils;
import org.ypbay.common.overlay.discover.node.NodeHandler;
import org.ypbay.common.overlay.discover.node.NodeManager;
import org.ypbay.common.overlay.message.Message;
import org.ypbay.common.parameter.CommonParameter;
import org.ypbay.common.runtime.ProgramResult;
import org.ypbay.common.utils.ByteArray;
import org.ypbay.common.utils.ByteUtil;
import org.ypbay.common.utils.DecodeUtil;
import org.ypbay.common.utils.Sha256Hash;
import org.ypbay.common.utils.Utils;
import org.ypbay.common.utils.WalletUtil;
import org.ypbay.common.zksnark.IncrementalMerkleTreeContainer;
import org.ypbay.common.zksnark.IncrementalMerkleVoucherContainer;
import org.ypbay.common.zksnark.JLibrustzcash;
import org.ypbay.common.zksnark.LibrustzcashParam.ComputeNfParams;
import org.ypbay.common.zksnark.LibrustzcashParam.CrhIvkParams;
import org.ypbay.common.zksnark.LibrustzcashParam.IvkToPkdParams;
import org.ypbay.common.zksnark.LibrustzcashParam.SpendSigParams;
import org.ypbay.consensus.ConsensusDelegate;
import org.ypbay.core.actuator.Actuator;
import org.ypbay.core.actuator.ActuatorFactory;
import org.ypbay.core.actuator.VMActuator;
import org.ypbay.core.capsule.AccountCapsule;
import org.ypbay.core.capsule.AssetIssueCapsule;
import org.ypbay.core.capsule.BlockBalanceTraceCapsule;
import org.ypbay.core.capsule.BlockCapsule;
import org.ypbay.core.capsule.BlockCapsule.BlockId;
import org.ypbay.core.capsule.BytesCapsule;
import org.ypbay.core.capsule.CodeCapsule;
import org.ypbay.core.capsule.ContractCapsule;
import org.ypbay.core.capsule.DelegatedResourceAccountIndexCapsule;
import org.ypbay.core.capsule.DelegatedResourceCapsule;
import org.ypbay.core.capsule.ExchangeCapsule;
import org.ypbay.core.capsule.IncrementalMerkleTreeCapsule;
import org.ypbay.core.capsule.IncrementalMerkleVoucherCapsule;
import org.ypbay.core.capsule.MarketAccountOrderCapsule;
import org.ypbay.core.capsule.MarketOrderCapsule;
import org.ypbay.core.capsule.MarketOrderIdListCapsule;
import org.ypbay.core.capsule.PedersenHashCapsule;
import org.ypbay.core.capsule.ProposalCapsule;
import org.ypbay.core.capsule.TransactionCapsule;
import org.ypbay.core.capsule.TransactionInfoCapsule;
import org.ypbay.core.capsule.TransactionResultCapsule;
import org.ypbay.core.capsule.TransactionRetCapsule;
import org.ypbay.core.capsule.WitnessCapsule;
import org.ypbay.core.capsule.utils.MarketUtils;
import org.ypbay.core.config.args.Args;
import org.ypbay.core.db.BandwidthProcessor;
import org.ypbay.core.db.BlockIndexStore;
import org.ypbay.core.db.EnergyProcessor;
import org.ypbay.core.db.Manager;
import org.ypbay.core.db.TransactionContext;
import org.ypbay.core.exception.AccountResourceInsufficientException;
import org.ypbay.core.exception.BadItemException;
import org.ypbay.core.exception.ContractExeException;
import org.ypbay.core.exception.ContractValidateException;
import org.ypbay.core.exception.DupTransactionException;
import org.ypbay.core.exception.HeaderNotFound;
import org.ypbay.core.exception.ItemNotFoundException;
import org.ypbay.core.exception.NonUniqueObjectException;
import org.ypbay.core.exception.PermissionException;
import org.ypbay.core.exception.SignatureFormatException;
import org.ypbay.core.exception.StoreException;
import org.ypbay.core.exception.TaposException;
import org.ypbay.core.exception.TooBigTransactionException;
import org.ypbay.core.exception.TransactionExpirationException;
import org.ypbay.core.exception.VMIllegalException;
import org.ypbay.core.exception.ValidateSignatureException;
import org.ypbay.core.exception.ZksnarkException;
import org.ypbay.core.net.TronNetDelegate;
import org.ypbay.core.net.TronNetService;
import org.ypbay.core.net.message.TransactionMessage;
import org.ypbay.core.store.AccountIdIndexStore;
import org.ypbay.core.store.AccountStore;
import org.ypbay.core.store.AccountTraceStore;
import org.ypbay.core.store.BalanceTraceStore;
import org.ypbay.core.store.ContractStore;
import org.ypbay.core.store.MarketOrderStore;
import org.ypbay.core.store.MarketPairPriceToOrderStore;
import org.ypbay.core.store.MarketPairToPriceStore;
import org.ypbay.core.store.StoreFactory;
import org.ypbay.core.utils.TransactionUtil;
import org.ypbay.core.zen.ShieldedTRC20ParametersBuilder;
import org.ypbay.core.zen.ShieldedTRC20ParametersBuilder.ShieldedTRC20ParametersType;
import org.ypbay.core.zen.ZenTransactionBuilder;
import org.ypbay.core.zen.address.DiversifierT;
import org.ypbay.core.zen.address.ExpandedSpendingKey;
import org.ypbay.core.zen.address.IncomingViewingKey;
import org.ypbay.core.zen.address.KeyIo;
import org.ypbay.core.zen.address.PaymentAddress;
import org.ypbay.core.zen.address.SpendingKey;
import org.ypbay.core.zen.note.Note;
import org.ypbay.core.zen.note.NoteEncryption;
import org.ypbay.core.zen.note.NoteEncryption.Encryption;
import org.ypbay.core.zen.note.OutgoingPlaintext;
import org.ypbay.protos.Protocol;
import org.ypbay.protos.Protocol.Account;
import org.ypbay.protos.Protocol.Block;
import org.ypbay.protos.Protocol.DelegatedResourceAccountIndex;
...
import org.ypbay.protos.Protocol.MarketPrice;
import org.ypbay.protos.Protocol.MarketPriceList;
import org.ypbay.protos.Protocol.Proposal;
import org.ypbay.protos.Protocol.Transaction;
import org.ypbay.protos.Protocol.Transaction.Contract;
import org.ypbay.protos.Protocol.Transaction.Contract.ContractType;
import org.ypbay.protos.Protocol.Transaction.Result.code;
...
import org.ypbay.protos.contract.BalanceContract;
import org.ypbay.protos.contract.BalanceContract.BlockBalanceTrace;
import org.ypbay.protos.contract.BalanceContract.TransferContract;
import org.ypbay.protos.contract.ShieldContract.IncrementalMerkleTree;
import org.ypbay.protos.contract.ShieldContract.IncrementalMerkleVoucherInfo;
import org.ypbay.protos.contract.ShieldContract.OutputPoint;
import org.ypbay.protos.contract.ShieldContract.OutputPointInfo;
import org.ypbay.protos.contract.ShieldContract.PedersenHash;
import org.ypbay.protos.contract.ShieldContract.ReceiveDescription;
import org.ypbay.protos.contract.ShieldContract.ShieldedTransferContract;
import org.ypbay.protos.contract.SmartContractOuterClass.CreateSmartContract;
import org.ypbay.protos.contract.SmartContractOuterClass.SmartContract;
import org.ypbay.protos.contract.SmartContractOuterClass.SmartContractDataWrapper;
...
public class Wallet {
  ...
  public DiversifierMessage getDiversifier() throws ZksnarkException {
    ...
    byte[] d;
    while (true) {
      d = org.ypbay.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public NodeList listNodes() {
    ...
    nodeHandlerMap.entrySet().stream()
        .forEach(v -> {
          org.ypbay.common.overlay.discover.node.Node node = v.getValue()
              .getNode();
