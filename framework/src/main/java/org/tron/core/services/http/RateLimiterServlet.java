...
import org.ypbay.core.services.ratelimiter.RateLimiterContainer;
import org.ypbay.core.services.ratelimiter.RuntimeData;
import org.ypbay.core.services.ratelimiter.adapter.DefaultBaseQqsAdapter;
import org.ypbay.core.services.ratelimiter.adapter.GlobalPreemptibleAdapter;
import org.ypbay.core.services.ratelimiter.adapter.IPQPSRateLimiterAdapter;
import org.ypbay.core.services.ratelimiter.adapter.IPreemptibleRateLimiter;
import org.ypbay.core.services.ratelimiter.adapter.IRateLimiter;
import org.ypbay.core.services.ratelimiter.adapter.QpsRateLimiterAdapter;

@Slf4j
public abstract class RateLimiterServlet extends HttpServlet {

  private static final String KEY_PREFIX_HTTP = "http_";
  private static final String ADAPTER_PREFIX = "org.ypbay.core.services.ratelimiter.adapter.";
