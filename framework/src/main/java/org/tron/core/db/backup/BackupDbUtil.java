package org.ypbay.core.db.backup;
...
import org.ypbay.core.db2.core.SnapshotRoot;
  ...
  private void backup(int i) throws RocksDBException {
    ...
    for (Chainbase store : stores) {
      if (((SnapshotRoot) (store.getHead().getRoot())).getDb().getClass()
          == org.ypbay.core.db2.common.RocksDB.class) {
        ((org.ypbay.core.db2.common.RocksDB) ((SnapshotRoot) (store.getHead().getRoot())).getDb())
            .getDb().backup(path);
      }
    }
  }
